...
public class FortuneController {
    ...
    @GetMapping("/mission")
    @Operation(
            summary = "유저의 일일 미션을 생성",
            description = "특정 유저의 일일 미션을 생성합니다.",
            responses = {
                    @ApiResponse(
                            responseCode = "200",
                            description = "일일 미션 생성을 성공했습니다.",
                            content = @Content(
                                    schema = @Schema(
                                            example = """
                                                {
                                                    "status": 200,
                                                    "message": "사용자 미션 생성에 성공했습니다.",
                                                    "data": [
                                                        {
                                                            "missionName": "매일 감사 실천하기",
                                                            "scores": {
                                                                "LOVE": 8
                                                            }
                                                        },
                                                        {
                                                            "missionName": "마음챙김 명상 참여하기",
                                                            "scores": {
                                                                "HEALTH": 7
                                                            }
                                                        },
                                                        {
                                                            "missionName": "긍정적인 책 읽기",
                                                            "scores": {
                                                                "STUDY": 5
                                                            }
                                                        }
    ...
    public ResponseEntity<ApiResponseTemplate<List<UserMissionResDto>>> createDailyMission(Principal principal){

        ApiResponseTemplate<List<UserMissionResDto>> data = fortuneService.createDailyMission(principal);
